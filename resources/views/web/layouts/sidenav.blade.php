...
<li class="nav-item">
                <a data-bs-toggle="collapse" href="{{route('users.index')}}" class="nav-link " aria-controls="dashboardsExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                    ...
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " href="{{route('users.index')}}">
                                <span class="sidenav-mini-icon"> C </span>
                                <span class="sidenav-normal"> Main Specializations </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="">
                                <span class="sidenav-mini-icon"> C </span>
                                <span class="sidenav-normal"> Sub Specializations </span>
                            </a>
                        </li>
                    </ul>
                </div>
